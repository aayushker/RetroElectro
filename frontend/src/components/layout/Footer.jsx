    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">RetroElectro</span>
            </div>
            <p className="text-gray-400 mb-4">
              Finding the perfect electronic device for you with the power of AI and user reviews.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to our newsletter for the latest product recommendations and tech news.</p>
            <form className="flex">
              <input
                type="email"
                placeholder="Your email"
                className="py-2 px-4 w-full rounded-l focus:outline-none text-gray-900"
              />
              <button
                type="submit"
                className="bg-blue-600 hover:bg-blue-700 py-2 px-4 rounded-r text-white"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-sm text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} RetroElectro. All rights reserved.</p>
